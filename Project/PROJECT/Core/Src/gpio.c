...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, DIG5_Pin|C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DIG4_Pin|DIG2_Pin|OLED_RES_Pin|OLED_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, DIG3_Pin|D_Pin|DP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, DIG6_Pin|A_Pin|B_Pin|E_Pin
                          |F_Pin|G_Pin|DIG1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIG4_Pin DIG2_Pin OLED_RES_Pin OLED_DC_Pin */
  GPIO_InitStruct.Pin = DIG4_Pin|DIG2_Pin|OLED_RES_Pin|OLED_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
